...
namespace Tabsquare.Payment
{
    ...
    public class UOBImplementation : PaymentInterface
    {
        ...
        public static Boolean isErrorProcessing = false;
                ...
                switch (commandType)
                {
                    ...
                    case "CRCARD": //CREDT CARD SALE (Function Code "I0"):
                        byteList = new byte[] {
                            ...
                            0X32,0X30,0X30,0X32,0X30,0X1C,0X36,0X30,0X30,0X30,0X30,0X30,
                            0X30,0X30,0X30,0X30,0X31,0X30,0X32,0X30,0X30,0X30,0X30,0X1C,0X34,0X30,0X00,0X12, //==>fixed

                            0X30,0X30,0X30,0X30,0X30,0X30,0X30,0X30,0X30,0X30,0X30,0X30,//==> amount
                            0X1C,0X58,0X31,0X00,0X02,0X30,0X31,0X1C, //==>fixed
        ...
        private static void ProcessStringResponse(string dataResponse, string session, String commandType)
        {
            ...
            switch (commandType)
            {
                ...
                case "CRCARD":
                    ...
                    if (dataResponse.Contains("Info Unavailable"))
                    {
                        isSucccessfull = false;
                        transactionResponse.result = "DECLINED";
                        transactionResponse.status = "DECLINED";
